...
tellraw @a ["",{"text":"Overworld ","color":"green"},{"text":"items given! ","color":"gold"},{"text":"Juggernauts","color":"dark_aqua"},{"text":", please enter the /track <dragon_ender username> command! Once that is done, the muffinhunt can begin!","color":"gold"}]
