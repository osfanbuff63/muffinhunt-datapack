...
give @a[tag=muffinhunt] golden_axe{Unbreakable:1,Enchantments:[{id:efficiency,lvl:3}],display:{Name:'[{"text":"Power Chopper","italic":"false","color":"gold"}]'},HideFlags:2} 
...
give @a[tag=muffinhunt] iron_shovel{Unbreakable:1,display:{Name:'[{"text":"Power Digger","italic":false,"color":"gold"}]'},Enchantments:[{id:efficiency,lvl:3}],HideFlags:101No}
