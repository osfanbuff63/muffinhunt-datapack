...
item replace entity @a[tag=juggernaut] armor.feet with golden_boots{Unbreakable:1,Enchantments:[{id:protection,lvl:5}]}
item replace entity @a[tag=juggernaut,tag=!no_juggernaut_pumpkin] armor.head with carved_pumpkin{display:{Name:'[{"text":"Enderman Protector","italic":false}]'},Enchantments:[{id:protection,lvl:3}],HideFlags:1} 1
item replace entity @a[tag=juggernaut,tag=no_juggernaut_pumpkin] armor.head with iron_helmet{Unbreakable:1,Enchantments:[{id:protection,lvl:3}]}
