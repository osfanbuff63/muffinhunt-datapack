...
item replace entity @a[team=juggernaut] container.6 with diamond_pickaxe{Unbreakable:1,display:{Name:'[{"text":"Emerald Pickaxe","color":"green","italic":"false"}]'},Enchantments:[{id:efficiency,lvl:2}]}
