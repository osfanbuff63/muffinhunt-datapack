...
item replace entity @a[team=juggernaut] container.2 with netherite_pickaxe{Unbreakable:1,display:{Name:'[{"text":"Copper Pickaxe","color":"#FFA500"}]'},Enchantments:[{id:efficency,lvl:2}]}
item replace entity @a[team=dragon_ender] container.1 with netherite_pickaxe{Unbreakable:1,display:{Name:'[{"text":"Copper Pickaxe","color":"#FFA500"}]'},Enchantments:[{id:efficency,lvl:2}]}
