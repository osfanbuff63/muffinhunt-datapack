...
item replace entity @a[team=juggernaut] container.6 with netherite_pickaxe{Unbreakable:1,display:{Name:'[{"text":"Copper Pickaxe","color":"#FFA500","italic":"false"}]'},Enchantments:[{id:efficency,lvl:2}]}
