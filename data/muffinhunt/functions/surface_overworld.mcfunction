...
execute as @a[team=dragon_ender] if score @s MuffinHuntRunnerLives > MuffinHuntLive3 MuffinHuntRunnerLives run scoreboard players remove @s MuffinHuntRunnerLives 1
