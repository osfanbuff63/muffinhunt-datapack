...
execute as @a[team=dragon_ender] if score @s MuffinHuntRunnerLives > MuffinHuntLive5 MuffinHuntRunnerLives run scoreboard players remove @s MuffinHuntRunnerLives 1
